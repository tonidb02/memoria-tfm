...
\fancyhead[RO]{Analysis of SBLOCA sequences with TRACE in APR1400 reactors} % Texto que se coloca en el encabezado de las páginas impares (O -> 'Odd', o impar) a la izquierda (R -> 'Odd')
...
\DeclareCaptionType{code}[Code][CODES INDEX] % Se define el entorno "Código" (de forma que al introducir un fragmento de código en el documento aparezca como: Código 1.1: ...), y la lista con los distintos códigos ("Índice de códigos").
...
\newglossary[ch1]{formel}{ch2}{ch3}{GLOSSARY}
