...
\newpage
\section*{APPENDICES} \label{sec:appendices} % Se añade un asterisco a \section para que el título no esté numerado.
\phantomsection
\addcontentsline{toc}{section}{APPENDICES} % Al utilizar \section* se ha de añadir manualmente el apartado al índice (Table Of Contents, TOC).
\markright{APPENDICES} % Al utilizar \section* se ha de añadir manualmente el título del apartado al encabezado.
