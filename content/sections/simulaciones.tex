...
\begin{enumerate}
  ...
  \begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{content/figures/pantalla1_simulacion1.JPG}
  ...
  \begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{content/figures/pantalla2_simulacion2.JPG}
...
\begin{enumerate}
  ...
  \begin{table}[h]
    ...
    \begin{figure}[h]
      \centering
      \includegraphics[width=0.67\textwidth]{content/figures/seguimiento_carga_smr.png}
      \vspace{-0.1cm}
...
\subsubsection{\textit{Feedback} de la práctica}
