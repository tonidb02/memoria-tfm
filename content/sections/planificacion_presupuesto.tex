    ...
    \begin{table}[h]
      ...
      \begin{tabular}{|ccccc|}
        ...
        \multicolumn{1}{|c|}{\cellcolor[HTML]{FFCCC9}Título} &
          \multicolumn{4}{c|}{\begin{tabular}[c]{@{}c@{}}SIMULACIÓN DE LAS MANIOBRAS DE SEGUIMIENTO DE CARGA CON \\ REACTORES MODULARES PEQUEÑOS MEDIANTE EL SIMULADOR \\ GRÁFICO INTERACTIVO DE LA CENTRAL NUCLEAR DE JOSÉ CABRERA \end{tabular}} \\ \hline
