...
\begin{figure}[h]
  ...
  \begin{figure}[!h]
    ...
    {2024-01-22}{2024-06-30} % inicio y final del eje temporal (año-mes-día).
    ...
    % Duración total:
    \ganttgroup{Trabajo Fin de Grado}{2024-02-01}{2024-06-23} \\
    
    \ganttgroup{Dirección del proyecto}{2024-02-01}{2024-06-23} \\
    ...
    \ganttbar[bar/.append style={fill=orange!50}]{Revisión}{2024-06-20}{2024-06-23} \\
    \ganttbar[bar/.append style={fill=orange!50}]{Entrega}{2024-06-23}{2024-06-23} \\
    ...
    \begin{table}[h]
      ...
      \multicolumn{1}{|c|}{\cellcolor[HTML]{FFCCC9}Título} &
        \multicolumn{4}{c|}{\begin{tabular}[c]{@{}c@{}}SIMULACIÓN DEL SEGUIMIENTO DE CARGA CON \\ \textit{SMALL MODULAR REACTORS} MEDIANTE EL\\ SIMULADOR GRÁFICO INTERACTIVO\end{tabular}} \\ \hline
      \multicolumn{1}{|c|}{\cellcolor[HTML]{FFCCC9}Duración} & \multicolumn{4}{c|}{143 días ($\sim$ 5 meses) = 429 horas}                                      \\ \hline
      \rowcolor[HTML]{ECF4FF} 
      ...
      \multicolumn{1}{|c|}{\cellcolor[HTML]{ACEBAB}Apellidos, Nombre} &
        ...
        Coste (€) \\ \hline
      \multicolumn{1}{|c|}{Jiménez Varas, Gonzalo}           & \multicolumn{1}{c|}{Tutor}   & \multicolumn{1}{c|}{40,00} & \multicolumn{1}{c|}{}    &         \\ \hline
      \multicolumn{1}{|c|}{Piedra Ajates, David}             & \multicolumn{1}{c|}{Cotutor} & \multicolumn{1}{c|}{40,00} & \multicolumn{1}{c|}{}    &         \\ \hline
      \multicolumn{1}{|c|}{Dies Beneytez, Antonio}           & \multicolumn{1}{c|}{Autor}   & \multicolumn{1}{c|}{10,00} & \multicolumn{1}{c|}{429} & 4290,00 \\ \hline
      \rowcolor[HTML]{FFCE93} 
      ...
      \multicolumn{2}{|c|}{\cellcolor[HTML]{ACEBAB}Descripción} &
        ...
        Coste (€) \\ \hline
      \multicolumn{2}{|c|}{Ordenador personal}                                              & \multicolumn{1}{c|}{11,90} & \multicolumn{1}{c|}{5}   & 59,50  \\ \hline
      \multicolumn{2}{|c|}{Ordenadores y sala del SGIZ}                                     & \multicolumn{1}{c|}{40,00} & \multicolumn{1}{c|}{5}   & 200,00  \\ \hline
      \rowcolor[HTML]{ECF4FF} 
      \multicolumn{5}{|c|}{\cellcolor[HTML]{ECF4FF}4. Resumen de costes}                                                                                      \\ \hline
      \multicolumn{4}{|c|}{Personal}                                                                                                                &         \\ \hline
      \multicolumn{4}{|c|}{Equipos}                                                                                                                 &         \\ \hline
      \multicolumn{4}{|c|}{IVA}                                                                                                                     & 21\%    \\ \hline
      \multicolumn{1}{|c|}{\cellcolor[HTML]{ACEBAB}Total}    & \multicolumn{4}{c|}{X EUROS CON XX CÉNTIMOS DE EURO}                                                                          \\ \hline
      \end{tabular}
      }
