...
\begin{enumerate}
  ...
  \item Completar la siguiente tabla, observar la figura \ref{fig:sim2_potencias} y contestar a la cuestión planteada:
  \begin{itemize}
